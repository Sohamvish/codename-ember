                                        ...
                                        <div className="flex items-center gap-4">
                                            <LikeButton
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    // Fallback: If RPC fails or doesn't exist, utilize direct update (less safe for concurrency but works for MVP)
                                                    // await supabase.from('stories').update({ likes_count: (story.likes_count || 0) + 1 }).eq('id', story.id);
                                                    // Note: We'll assume the user sets up the simplified column update or RPC. 
                                                    // For hackathon simplicity, let's use the direct update method if RPC is too complex to setup right now.
